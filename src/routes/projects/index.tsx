...
function RouteComponent() {
  return (
    <div className="flex grow flex-col items-start justify-center gap-y-8 p-16">
      <div className="flex w-full flex-row">
        <span className="text-center text-2xl font-bold text-blue-700 [text-orientation:upright] [writing-mode:vertical-rl]">
          2026
        </span>
        ...
        <div className="flex flex-col gap-y-2 pl-4">
          <a
            className="text-3xl font-black text-blue-700 hover:underline"
      ...
      <div className="flex w-full flex-row">
        <span className="text-center text-2xl font-bold text-yellow-600 [text-orientation:upright] [writing-mode:vertical-rl]">
          2025
        </span>
        ...
        <div className="flex flex-col gap-y-2 pl-4">
          <a
            className="text-3xl font-black text-yellow-600 hover:underline"
      ...
      <div className="flex w-full flex-row">
        <span className="text-center text-2xl font-bold text-green-700 [text-orientation:upright] [writing-mode:vertical-rl]">
          2025
        </span>
        ...
        <div className="flex flex-col gap-y-2 pl-4">
          <a
            className="text-3xl font-black text-green-700 hover:underline"
